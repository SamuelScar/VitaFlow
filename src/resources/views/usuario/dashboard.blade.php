            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    ...
                    <p class="text-secondary mb-0">
                        Acompanhe campanhas abertas e veja os proximos passos para apoiar uma arrecadacao.
                    </p>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="dashboard-summary p-4">
                        ...
                        <span class="text-secondary">Conta pronta para participar de campanhas.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="container py-5">
        <div class="row g-4">
            <div class="col-md-6 col-xl-4">
                <article class="card dashboard-card h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="text-secondary mb-4">Veja campanhas disponiveis e escolha onde deseja contribuir.</p>
            ...
            <div class="col-md-6 col-xl-4">
                <article class="card dashboard-card h-100">
                    <div class="card-body p-4">
                        <h2 class="h5">Minhas doacoes</h2>
                        <p class="text-secondary mb-4">Historico de doacoes ficara disponivel quando o fluxo for criado.</p>
            ...
            <div class="col-md-6 col-xl-4">
                <article class="card dashboard-card h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="text-secondary mb-4">Mantenha seus dados atualizados para participar das campanhas.</p>
                        <button class="btn btn-outline-secondary" type="button" disabled>Em breve</button>
                    </div>
                </article>
            </div>
